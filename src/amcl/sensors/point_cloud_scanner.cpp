...
double
PointCloudScanner::applyModelToSampleSet(std::shared_ptr<SensorData> data, PFSampleSet *set)
{
...
double
PointCloudScanner::calcPointCloudModel(std::shared_ptr<PointCloudData> data, PFSampleSet* set)
{
  std::shared_ptr<PointCloudScanner> self;
...
double
PointCloudScanner::calcPointCloudModelGompertz(std::shared_ptr<PointCloudData> data, PFSampleSet* set)
{
  std::shared_ptr<PointCloudScanner> self;
