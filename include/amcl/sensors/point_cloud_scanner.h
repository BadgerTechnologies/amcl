...
class PointCloudScanner : public Sensor
{
  ...
  private:
    ...
    static double calcPointCloudModel(std::shared_ptr<PointCloudData> data, PFSampleSet *set);
    static double calcPointCloudModelGompertz(std::shared_ptr<PointCloudData> data, PFSampleSet *set);
    static bool getMapCloud(std::shared_ptr<PointCloudScanner> self, std::shared_ptr<PointCloudData> data,
